<%-- 
    Document   : login
    Created on : Jan 15, 2014, 10:34:57 PM
    Author     : Nisha
--%>
...
<head>
		...
		<meta name="author" content="unisys cloud 2020">
			...
			<div role="main" class="main">
				...
				<div class="container">
					...
					<div class="row">
						...
						<form action="log" id="regForm" name="regForm" type="post">
                                                            
								<div class="row">
									<div class="form-group">
										<div class="col-md-6">
                                                                                    <label>User ID</label>
											<input type="text" value="" maxlength="100" class="form-control" name="id" id="id">
										</div>
                                                                            <div class="col-md-6">
											<label>Password</label>
											<input type="password" value="" maxlength="100" class="form-control" name="pass" id="pass">
										</div>
                                                                          </div>
								</div>
						...
						<div class="col-md-6">
							...
							<p>A place to save your space!!!</p>
