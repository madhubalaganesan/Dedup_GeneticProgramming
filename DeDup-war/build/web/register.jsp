<%-- 
    Document   : register
    Created on : Jan 15, 2014, 9:56:38 PM
    Author     : Nisha
--%>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<h2 class="short"><strong>Contact</strong> Us</h2>-->
                                                        ...
                                                        <form action="reg" id="regForm" name="regForm" type="post">
                                                            
								<div class="row">
									<div class="form-group">
										<div class="col-md-6">
                                                                                    <label>First Name</label>
											<input type="text" value="" maxlength="100" class="form-control" name="first" id="first">
										</div>
                                                                            <div class="col-md-6">
                                                                                    <label>Last Name</label>
											<input type="text" value="" maxlength="100" class="form-control" name="last" id="last">
										</div>
                                                                            <div class="col-md-6">
											<label>User ID</label>
											<input type="text" value="" maxlength="100" class="form-control" name="user_id" id="user_id">
										</div>
                                                                            <div class="col-md-6">
											<label>Email ID</label>
											<input type="text" value=""  maxlength="100" class="form-control" name="email_id" id="email_id">
										</div>
                                                                            <div class="col-md-6">
											<label>Password</label>
											<input type="password" value="" maxlength="100" class="form-control" name="password" id="password">
										</div>
                                                                            
                                                                            <div class="col-md-6">
											<label>Confirm Password</label>
											<input type="password" value="" maxlength="100" class="form-control" name="password2" id="password2">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<input type="button" value="Submit" onclick="regis();" class="btn btn-primary btn-lg">
									</div>
								</div>
							</form>
						</div>
						<div class="col-md-6">
							...
							<h4 class="pull-top">Register to <strong>Nimbus Drive</strong></h4>
							<p>Get to have a place where you can have your documents for yourself!</p>
...
<!-- Mirrored from www.crivosthemes.com/theme/porto/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 15 Jan 2014 07:52:58 GMT -->
</html>
