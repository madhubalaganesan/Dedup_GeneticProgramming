<%-- 
    Document   : upload
    Created on : Jan 15, 2014, 10:24:40 PM
    Author     : Nisha
--%>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<form id="regForm" enctype="multipart/form-data" action="upFile.jsp" method="post">
                                                            
								<div class="row">
									<div class="form-group">
										<div class="col-md-6">
                                                                                    <label>Upload File</label>
											<input type="file" name="ImageFile" value="Choose File" class="form-control" id="ImageFile">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<input type="Submit" value="Process"  class="btn btn-primary btn-lg">
									</div>
								</div>
							</form>
						</div>
						<div class="col-md-6">
							...
							<p>Our drive makes sure multiple copies or duplicates do not emaciate your space!</p>
